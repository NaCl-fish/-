...
def cnn_inference(images, batch_size, n_classes, is_training):
    ...
    with tf.variable_scope('conv1') as scope:
        ...
        bn1 = tf.layers.batch_normalization(pre_activation, training=is_training)

        conv1 = tf.nn.relu(bn1, name='conv1')   # 用relu激活函数非线性化处理
    ...
    with tf.variable_scope('conv2') as scope:
        ...
        bn2 = tf.layers.batch_normalization(pre_activation, training=is_training)

        conv2 = tf.nn.relu(bn2, name='conv2')
